...
class Ui_sceneGraphBrowser(object):
    def setupUi(self, sceneGraphBrowser):
        ...
        self.propertiesTable = QtGui.QTableWidget(self.centralwidget)
        ...
        self.colorPickerButton = QtGui.QPushButton(self.centralwidget)
        ...
        self.onPickedButton = QtGui.QPushButton(self.centralwidget)
        self.onPickedButton.setObjectName(_fromUtf8("onPickedButton"))
        self.horizontalLayout.addWidget(self.onPickedButton)
        self.onWalkedButton = QtGui.QPushButton(self.centralwidget)
    ...
    def retranslateUi(self, sceneGraphBrowser):
        ...
        self.copyButton.setText(_translate("sceneGraphBrowser", "Copy", None))
        self.pasteButton.setText(_translate("sceneGraphBrowser", "Paste", None))
